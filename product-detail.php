    ...
    <section class="my-5">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><span class="mr-1"><strong>Gía  <?php echo number_format("$price") ?></strong> VND</span></p>
            ...
            if (isset($_SESSION['email'])) {
              ...
              if (isset($_POST['submit'])) {
                ...
                if (mysqli_num_rows($run_cart) == 0) {
                  $cart_query = "INSERT INTO `cart`(`cust_id`, `product_id`,quantity,size) VALUES ($custid,$p_id,$qty)";
