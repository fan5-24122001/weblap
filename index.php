...
<div class="carousel slide mt-5" id="slider" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/banner11.png" class="d-block w-100">

    </div>
    <div class="carousel-item">
      <img src="img/122.png" class="d-block w-100">
    </div>
    <div class="carousel-item">
      <img src="img/12222.png" class="d-block w-100">
    </div>
...
<section>
  <div class="container pt-5 pb-5">
    ...
    <div class="row mt-4">
      ...
      <?php
      $p_query = "SELECT * FROM furniture_product ORDER BY pid DESC LIMIT 8";
      ...
      ?>
          ...
          <div class="col-md-3 mt-3">
            ...
            <div class="text-center mt-3">
              ...
              <h6>Rs.  <?php echo number_format("$p_price") ?></strong> VND</h6>
            </div>
